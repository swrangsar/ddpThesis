...
we find that some frequency bands are unoccupied most of the time[7]. These 
...
location, the band is not being utilized by that user.[4]
...
efficiently.5,2,6 kranti. It uses one of the spectrum sensing techniques to 
...
channel.  Chapter 7 covers a implementation of cognitive radio using GNU Radio
