...
Chapter 3 gives a literature survey on Universal Software Radio Peripheral 
(USRP N210). 
Chapter 4 and 5 describe the literature survey done on the GNU Radio software 
package and OpenBTS software respectively. 
Chapter 6 covers a partial implementation of cognitive radio using GNU Radio 
and OpenBTS. 
It also describes the proposed future work along with a flowgraph describing 
the algorithm for the complete implementation of cognitive radio on the 
OpenBTS platform.
