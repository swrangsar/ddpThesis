...
the peak in energy levels. This method was used to ascertain that the peak in 
the energy levels in a given channel are not just due to some random 
fluctuations in the noise power.
