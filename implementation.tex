...
\section{A brief list of the things done over the year}

What follows is a brief overview of the things done and the challenges faced 
during the course of the project.

\begin{enumerate}
    \item We began by trying to get acquainted with Cognitive Radio. We did a
    literature survey on Cognitive Radio and all the research going on in the
