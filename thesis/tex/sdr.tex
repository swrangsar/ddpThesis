...
\caption[Architecture of GNURadio]{Architecture of GNURadio {\cite{kranthi13}}}
...
software. The \gls{uhd} provides a host driver and an \gls{api} for the
\gls{usrp}. GNURadio uses the \gls{uhd} to set user-specified
parameters like \gls{rf} center frequency, antenna selection, gain, sampling rate,
