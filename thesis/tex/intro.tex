...
\begin{enumerate}
    ...
    primary users is detected in $F_1$  the secondary system switches from $F_1$ 
...
tools that make SDR possible such as the Universal Software Radio Peripheral 
...
Cognitive Radio (CR) Test-Bed that we have developed using OpenBTS. Flowgraphs of
